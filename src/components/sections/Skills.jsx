...
const skillGroups = [
  {
    ...
    summary: "Building reliable pipelines, distributed processing systems, and cloud analytics flows.",
    ...
    skills: [
      ...
      { name: "PySpark", icon: <SiApachespark className="text-yellow-400" /> },
      { name: "Apache Flink", icon: <FaProjectDiagram className="text-sky-400" /> },
      { name: "Hadoop", icon: <FaServer className="text-violet-400" /> },
      { name: "HDFS", icon: <FaServer className="text-indigo-400" /> },
      { name: "Hive", icon: <FaProjectDiagram className="text-emerald-400" /> },
      { name: "HBase", icon: <FaDatabase className="text-cyan-400" /> },
      { name: "Elasticsearch", icon: <FaProjectDiagram className="text-lime-400" /> },
      { name: "ClickHouse", icon: <FaServer className="text-pink-400" /> },
      { name: "ZooKeeper", icon: <FaTools className="text-amber-400" /> },
      ...
      { name: "MinIO", icon: <FaCloud className="text-cyan-400" /> },
  ...
  {
    title: "Programming",
    summary: "Core software development skills for building scalable, maintainable, and data-driven systems.",
    ...
    skills: [
      ...
      { name: "Jupyter Notebook", icon: <FaCode className="text-purple-400" /> },
    ],
  },
  {
    title: "Tools & Deployment",
    summary: "DevOps, containerization, automation, cloud deployment, and distributed infrastructure practices.",
    icon: <FaTools className="text-3xl text-orange-400" />,
    skills: [
      { name: "Docker", icon: <SiDocker className="text-sky-500" /> },
      { name: "Kubernetes", icon: <FaServer className="text-blue-400" /> },
      { name: "K3s", icon: <FaServer className="text-cyan-400" /> },
      { name: "Tailscale", icon: <FaCloud className="text-purple-400" /> },
